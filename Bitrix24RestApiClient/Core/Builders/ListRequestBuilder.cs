...
public class ListRequestBuilder<TEntity> : IListRequestBuilder<TEntity>, IStageHistoriesListRequestBuilder<TEntity>, IListAllRequestBuilder<TEntity>
{
    ...
    private List<string> select = new();
    ...
    private ListRequestBuilder(int? entityTypeId, int? start, bool selectAll, List<string> select, List<Filter> filter, List<Order> order)
    {
