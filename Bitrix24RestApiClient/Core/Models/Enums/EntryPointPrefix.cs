...
public class EntryPointPrefix
{
    ...
    public static EntryPointPrefix CalendarAccessibility = new() { Value = "calendar.accessibility" };
    public static EntryPointPrefix CalendarEvent = new() { Value = "calendar.event" };
    public static EntryPointPrefix CalendarMeeting = new() { Value = "calendar.meeting" };
}